        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const bundleMapper = (bundleInfo) => __awaiter(this, void 0, void 0, function* () {
                ...
                const config = Object.assign(Object.assign({}, this.buildOptions), { external: [
                    ...
                    ], entryPoints: [entry], outdir: path.join(this.buildDirPath, path.dirname(entry)), incremental, plugins: this.plugins });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (service.package.individually || this.options.function) {
                Object.values(this.functions).forEach((func) => {
                    func.package.artifact = path.join(this.serviceDirPath, constants_1.SERVERLESS_FOLDER, path.basename(func.package.artifact));
                });
                return;
            }
